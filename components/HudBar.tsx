...
import { owner } from "@/content/telemetry";
import { LocaleToggle } from "./LocaleToggle";

/* lucide dropped brand icons, so the GitHub mark is inlined (official path). */
...
export function HudBar({
  ...
  return (
    <div className="hud-top" style={{ visibility: hidden ? "hidden" : "visible" } as CSSProperties}>
      ...
      <a href={`https://${owner.url}`} target="_blank" rel="noreferrer" className="nav-btn">
        <GithubMark /> GitHub
      </a>
      <LocaleToggle />
    </div>
